...
Block::Block(float t_X, float t_Y, float t_Width, float t_Height, int color_R, int color_G, int color_B)
{
	shape.setPosition(t_X, t_Y);
	shape.setSize({ t_Width, t_Height });
	shape.setFillColor(Color::Color(color_R, color_G, color_B));
